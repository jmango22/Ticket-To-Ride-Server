...
//        }
    ...
    public static void printClasspath() {
        try {
            ExtensionLoader<IDatabaseController> loader = new ExtensionLoader<>();
            IDatabaseController controller = loader.LoadClass("/plugins", "edu.goldenhammer.database.mongo.MongoController", IDatabaseController.class);
